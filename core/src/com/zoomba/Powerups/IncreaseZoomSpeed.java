 ...
 */
public class IncreaseZoomSpeed extends Powerup {
    public IncreaseZoomSpeed(float x, float y, float radius, float orientation, float velocity,
                             int lifetime, int existence) {
        super(x, y, radius, orientation, velocity, lifetime, existence, PowerupTypes.IncreaseZoomSpeed);
    }
