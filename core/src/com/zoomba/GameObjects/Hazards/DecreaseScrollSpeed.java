 ...
 */
public class DecreaseScrollSpeed extends Hazard {
    public DecreaseScrollSpeed(float x, float y, float radius, float orientation, float velocity,
                               int lifetime, int existence) {
        super(x, y, radius, orientation, velocity, lifetime, existence, HazardTypes.DecreaseScrollSpeed);
    }
